...
|:------------------------|------------:|------------:|------------:|------------:|
| std_memeq               |  189.070 µs |  167.470 µs |  346.650 µs |  365.400 µs |
| libc_memeq              |  163.950 µs |  169.320 µs |  341.980 µs |  361.230 µs |
| memx_memeq              |  120.240 µs |  112.900 µs |  121.710 µs |  115.920 µs |
| memx_memeq_basic        |  119.580 µs |  112.880 µs |  121.420 µs |  115.920 µs |

  2. i686-unknown-linux-:

|         `name`          |  `gnu:en`   |  `gnu:ja`   |  `musl:en`  |  `musl:ja`  |
|:------------------------|------------:|------------:|------------:|------------:|
| std_memeq               |  209.980 µs |  208.840 µs |  386.060 µs |  525.040 µs |
| libc_memeq              |  192.490 µs |  212.360 µs |  385.290 µs |  524.570 µs |
| memx_memeq              |  191.990 µs |  177.140 µs |  179.970 µs |  162.560 µs |
| memx_memeq_basic        |  191.670 µs |  177.360 µs |  177.540 µs |  162.940 µs |

  3. i586-unknown-linux-:

|         `name`          |  `gnu:en`   |  `gnu:ja`   |  `musl:en`  |  `musl:ja`  |
|:------------------------|------------:|------------:|------------:|------------:|
| std_memeq               |  197.440 µs |  211.540 µs |  365.730 µs |  518.850 µs |
| libc_memeq              |  197.910 µs |  211.690 µs |  366.000 µs |  518.470 µs |
| memx_memeq              |  193.650 µs |  175.530 µs |  181.370 µs |  160.640 µs |
| memx_memeq_basic        |  193.290 µs |  175.660 µs |  180.580 µs |  170.880 µs |
