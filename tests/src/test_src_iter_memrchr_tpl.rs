...
fn test00() {
    let buf = vec![];
    let mut iter = test_memrchr_tpl_iter(&buf, b'X', b'G', b'g');
    ...
    let mut iter = test_memrchr_tpl_iter(&buf, b'X', b'A', b'a');
    ...
    //
    let buf = vec![b'A', b'B', b'C'];
    let mut iter = test_memrchr_tpl_iter(&buf, b'X', b'B', b'b');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    assert_eq!(iter.next(), Some(1));
    assert_eq!(iter.next(), None);
    assert_eq!(iter.next_back(), Some(1));
    ...
    //
    let buf = vec![b'A', b'B', b'C'];
    let mut iter = test_memrchr_tpl_iter(&buf, b'X', b'C', b'c');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    ...
    //
    let buf = vec![b'A', b'B', b'C'];
    let mut iter = test_memrchr_tpl_iter(&buf, b'X', b'a', b'b');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    assert_eq!(iter.next(), None);
    assert_eq!(iter.next_back(), None);
    let mut iter = test_memrchr_tpl_iter(&buf, b'X', b'b', b'a');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    assert_eq!(iter.next(), None);
    assert_eq!(iter.next_back(), None);
}
