...
#[test]
fn test_memrnechr_dbl_empty_buffer() {
    let buf = [];
...
#[test]
fn test_memrnechr_dbl_long_buffer() {
    let buf = [b'a'; 1024];
    ...
    assert_eq!(test_memrnechr_dbl(&long_buf, b'a', b'b'), expected_idx);
}

#[test]
fn test_memrnechr_dbl_long_buffer_not_found() {
    let buf = [b'a'; 1024];
    assert_eq!(test_memrnechr_dbl(&buf, b'a', b'b'), None);
}
