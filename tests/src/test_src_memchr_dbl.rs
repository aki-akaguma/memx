...
fn test00() {
    let buf = vec![];
    let r = test_memchr_dbl(&buf, b'G', b'g');
    assert_eq!(r, None);
    //
    let buf = vec![b'A', b'g'];
    let r = test_memchr_dbl(&buf, b'G', b'g');
    ...
    let r = test_memchr_dbl(&buf, b'A', b'a');
    assert_eq!(r, Some(0));
    let r = test_memchr_dbl(&buf, b'a', b'A');
    assert_eq!(r, Some(0));
    //
    let buf = vec![b'A', b'B', b'C'];
    let r = test_memchr_dbl(&buf, b'B', b'b');
    assert_eq!(r, Some(1));
    let r = test_memchr_dbl(&buf, b'b', b'B');
    assert_eq!(r, Some(1));
    //
    let buf = vec![b'A', b'B', b'C'];
    let r = test_memchr_dbl(&buf, b'C', b'c');
    assert_eq!(r, Some(2));
    let r = test_memchr_dbl(&buf, b'c', b'C');
    assert_eq!(r, Some(2));
    //
    ...
    assert_eq!(r, None);
    let r = test_memchr_dbl(&buf, b'b', b'a');
    assert_eq!(r, None);
}
#[test]
fn test01() {
