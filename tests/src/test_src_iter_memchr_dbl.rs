...
fn test00() {
    ...
    let mut iter = test_memchr_dbl_iter(&buf, b'A', b'a');
    ...
    //
    let buf = vec![b'A', b'B', b'C'];
    let mut iter = test_memchr_dbl_iter(&buf, b'B', b'b');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    assert_eq!(iter.next(), Some(1));
    assert_eq!(iter.next(), None);
    assert_eq!(iter.next_back(), Some(1));
    ...
    //
    let buf = vec![b'A', b'B', b'C'];
    let mut iter = test_memchr_dbl_iter(&buf, b'C', b'c');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    ...
    //
    let buf = vec![b'A', b'B', b'C'];
    let mut iter = test_memchr_dbl_iter(&buf, b'a', b'b');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    assert_eq!(iter.next(), None);
    assert_eq!(iter.next_back(), None);
    let mut iter = test_memchr_dbl_iter(&buf, b'b', b'a');
    assert_eq!(iter.size_hint(), (0, Some(3)));
    assert_eq!(iter.next(), None);
    assert_eq!(iter.next_back(), None);
}
