...
#[inline(always)]
fn _nechr_sgl_to_aligned<const ALIGN: usize>(
    buf_ptr: *const u8,
    c: B1Sgl,
    start_ptr: *const u8,
...
pub(crate) fn _nechr_sgl_to_aligned_u256(
    ...
    _nechr_sgl_to_aligned::<32>(buf_ptr, c, start_ptr)
}
...
pub(crate) fn _nechr_sgl_to_aligned_u128(
    ...
    _nechr_sgl_to_aligned::<16>(buf_ptr, c, start_ptr)
}
...
fn _nechr_sgl_to_aligned_u64(
    ...
    _nechr_sgl_to_aligned::<8>(buf_ptr, c, start_ptr)
}
...
fn _nechr_sgl_to_aligned_u32(
    ...
    _nechr_sgl_to_aligned::<4>(buf_ptr, c, start_ptr)
}
...
#[inline(always)]
fn _nechr_c8_uu_x1(buf_ptr: *const u8, c8: B8Sgl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _nechr_c4_uu_x1(buf_ptr: *const u8, c4: B4Sgl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _nechr_c1_aa_x1(buf_ptr: *const u8, c1: B1Sgl, st_ptr: *const u8) -> Option<usize> {
    let aa_ptr = buf_ptr;
