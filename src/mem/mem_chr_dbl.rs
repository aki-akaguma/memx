...
#[inline(never)]
pub fn _memchr_dbl_impl(buf: &[u8], needle: B1Dbl) -> Option<usize> {
    #[cfg(all(
        feature = "test",
...
#[inline(always)]
fn _chr_dbl_to_aligned<const ALIGN: usize>(
    buf_ptr: *const u8,
    c: B1Dbl,
    st_ptr: *const u8,
    ...
    while cur_ptr < buf_ptr_end {
        if let Some(pos) = _chr_dbl_c1_aa_x1(cur_ptr, c, st_ptr) {
...
pub(crate) fn _chr_dbl_to_aligned_u256(
    ...
    _chr_dbl_to_aligned::<32>(buf_ptr, c, st_ptr)
}
...
pub(crate) fn _chr_dbl_to_aligned_u128(
    ...
    _chr_dbl_to_aligned::<16>(buf_ptr, c, st_ptr)
}
...
fn _chr_dbl_to_aligned_u64(
    ...
    _chr_dbl_to_aligned::<8>(buf_ptr, c, st_ptr)
}
...
fn _chr_dbl_to_aligned_u32(
    ...
    _chr_dbl_to_aligned::<4>(buf_ptr, c, st_ptr)
}

#[cfg(any(target_pointer_width = "64", feature = "test_pointer_width_64"))]
#[inline(always)]
fn _start_chr_64(buf: &[u8], needle: B1Dbl) -> Option<usize> {
    let buf_len = buf.len();
    ...
    if buf_len >= 8 {
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u64() {
                ...
                {
                    let r = _chr_dbl_c8_uu_x1(buf_ptr, cc, start_ptr);
                    if r.is_some() {
                        return r;
                    }
                ...
                {
                    let r = _chr_dbl_to_aligned_u64(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
...
#[inline(always)]
fn _start_chr_32(buf: &[u8], needle: B1Dbl) -> Option<usize> {
    let buf_len = buf.len();
    let mut buf_ptr = buf.as_ptr();
    let start_ptr = buf_ptr;
    let end_ptr = unsafe { buf_ptr.add(buf_len) };
    ...
    if buf_len >= 4 {
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u32() {
                ...
                #[cfg(not(feature = "test_alignment_check"))]
                {
                    let r = _chr_dbl_c4_uu_x1(buf_ptr, cc, start_ptr);
                    if r.is_some() {
                        return r;
                    }
                ...
                #[cfg(feature = "test_alignment_check")]
                {
                    let r = _chr_dbl_to_aligned_u32(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
                    } else if let Some(v) = r.1 {
                        return Some(v);
...
#[inline(always)]
fn _memchr_dbl_remaining_3_bytes_impl(
    buf_ptr: *const u8,
    cc: B2Dbl,
    start_ptr: *const u8,
    end_ptr: *const u8,
...
#[inline(always)]
fn _chr_dbl_c16_aa_x1(buf_ptr: *const u8, c16: B16Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c16_aa_x2(buf_ptr: *const u8, c16: B16Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c16_aa_x4(buf_ptr: *const u8, c16: B16Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c16_aa_x8(buf_ptr: *const u8, c16: B16Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c8_uu_x1(buf_ptr: *const u8, c8: B8Dbl, st_ptr: *const u8) -> Option<usize> {
    _chr_dbl_c8_aa_x1(buf_ptr, c8, st_ptr)
}

#[inline(always)]
fn _chr_dbl_c8_aa_x1(buf_ptr: *const u8, c8: B8Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c8_aa_x2(buf_ptr: *const u8, c8: B8Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c8_aa_x4(buf_ptr: *const u8, c8: B8Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c8_aa_x8(buf_ptr: *const u8, c8: B8Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c4_uu_x1(buf_ptr: *const u8, c4: B4Dbl, st_ptr: *const u8) -> Option<usize> {
    _chr_dbl_c4_aa_x1(buf_ptr, c4, st_ptr)
}

#[inline(always)]
fn _chr_dbl_c4_aa_x1(buf_ptr: *const u8, c4: B4Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c4_aa_x2(buf_ptr: *const u8, c4: B4Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c4_aa_x4(buf_ptr: *const u8, c4: B4Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c4_aa_x8(buf_ptr: *const u8, c4: B4Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c2_aa_x1(buf_ptr: *const u8, c2: B2Dbl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _chr_dbl_c1_aa_x1(buf_ptr: *const u8, c1: B1Dbl, st_ptr: *const u8) -> Option<usize> {
    let aa_ptr = buf_ptr;
