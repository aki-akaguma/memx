...
#[inline(always)]
fn _start_nechr_128(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    let buf_len = buf.len();
    ...
    if buf_len >= 16 {
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u128() {
                ...
                {
                    let r = _nechr_qpl_to_aligned_u128(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
    ...
    _memnechr_qpl_remaining_15_bytes_impl(buf_ptr, cc.into(), start_ptr, end_ptr)
}
...
fn _start_nechr_64(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    ...
    _memnechr_qpl_remaining_7_bytes_impl(buf_ptr, cc.into(), start_ptr, end_ptr)
}
...
fn _start_nechr_32(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    ...
    _memnechr_qpl_remaining_3_bytes_impl(buf_ptr, cc.into(), start_ptr, end_ptr)
}

#[inline(always)]
pub(crate) fn _memnechr_qpl_remaining_15_bytes_impl(
    buf_ptr: *const u8,
    cc: B8Qpl,
    start_ptr: *const u8,
    end_ptr: *const u8,
...
#[inline(always)]
pub(crate) fn _memnechr_qpl_remaining_7_bytes_impl(
    buf_ptr: *const u8,
    cc: B4Qpl,
    start_ptr: *const u8,
    end_ptr: *const u8,
...
#[inline(always)]
fn _memnechr_qpl_remaining_3_bytes_impl(
    buf_ptr: *const u8,
    cc: B2Qpl,
    start_ptr: *const u8,
    end_ptr: *const u8,
...
#[inline(always)]
fn _return_nechr_qpl<T, PU>(base: T, bits_ab: PU) -> Option<usize>
where
...
#[inline(always)]
fn _nechr_c16_uu_x1(buf_ptr: *const u8, c16: B16Qpl, st_ptr: *const u8) -> Option<usize> {
    _nechr_c16_aa_x1(buf_ptr, c16, st_ptr)
}

#[inline(always)]
fn _nechr_c16_aa_x1(buf_ptr: *const u8, c16: B16Qpl, st_ptr: *const u8) -> Option<usize> {
    ...
    //
    _return_nechr_qpl(base, bits_0_abcd)
}
...
#[inline(always)]
fn _nechr_c8_uu_x1(buf_ptr: *const u8, c8: B8Qpl, st_ptr: *const u8) -> Option<usize> {
    _nechr_c8_aa_x1(buf_ptr, c8, st_ptr)
}

#[inline(always)]
fn _nechr_c8_aa_x1(buf_ptr: *const u8, c8: B8Qpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _nechr_c4_uu_x1(buf_ptr: *const u8, c4: B4Qpl, st_ptr: *const u8) -> Option<usize> {
    _nechr_c4_aa_x1(buf_ptr, c4, st_ptr)
}

#[inline(always)]
fn _nechr_c4_aa_x1(buf_ptr: *const u8, c4: B4Qpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _nechr_c2_aa_x1(buf_ptr: *const u8, c2: B2Qpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _nechr_c1_aa_x1(buf_ptr: *const u8, c1: B1Qpl, st_ptr: *const u8) -> Option<usize> {
    let aa_ptr = buf_ptr;
