...
#[inline(never)]
pub fn _memrnechr_tpl_impl(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    #[cfg(all(
        feature = "test",
...
#[inline(always)]
fn _rnechr_tpl_to_aligned<const ALIGN: usize>(
...
#[inline(always)]
pub(crate) fn _rnechr_tpl_to_aligned_u256(
    buf_ptr_cur: *const u8,
    c: B1Tpl,
    start_ptr: *const u8,
) -> (Option<*const u8>, Option<usize>) {
    _rnechr_tpl_to_aligned::<32>(buf_ptr_cur, c, start_ptr)
}

#[inline(always)]
pub(crate) fn _rnechr_tpl_to_aligned_u128(
    buf_ptr_cur: *const u8,
    c: B1Tpl,
    start_ptr: *const u8,
) -> (Option<*const u8>, Option<usize>) {
    _rnechr_tpl_to_aligned::<16>(buf_ptr_cur, c, start_ptr)
}

#[inline(always)]
fn _rnechr_tpl_to_aligned_u64(
    buf_ptr_cur: *const u8,
    c: B1Tpl,
    start_ptr: *const u8,
) -> (Option<*const u8>, Option<usize>) {
    _rnechr_tpl_to_aligned::<8>(buf_ptr_cur, c, start_ptr)
}

#[inline(always)]
fn _rnechr_tpl_to_aligned_u32(
    buf_ptr_cur: *const u8,
    c: B1Tpl,
    start_ptr: *const u8,
) -> (Option<*const u8>, Option<usize>) {
    _rnechr_tpl_to_aligned::<4>(buf_ptr_cur, c, start_ptr)
}

#[cfg(any(target_pointer_width = "64", feature = "test_pointer_width_64"))]
#[inline(always)]
fn _start_rnechr_64(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    let buf_len = buf.len();
    ...
    if buf_len >= 8 {
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u64() {
                let r = _rnechr_tpl_to_aligned_u64(buf_ptr, needle, start_ptr);
                if let Some(p) = r.0 {
                    buf_ptr = p;
    ...
    _memrnechr_tpl_remaining_7_bytes_impl(buf_ptr, cc.into(), start_ptr)
}

#[cfg(any(target_pointer_width = "32", feature = "test_pointer_width_32"))]
#[inline(always)]
fn _start_rnechr_32(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    let buf_len = buf.len();
    let start_ptr = buf.as_ptr();
    let mut buf_ptr = unsafe { start_ptr.add(buf_len) };
    ...
    if buf_len >= 4 {
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u32() {
                let r = _rnechr_tpl_to_aligned_u32(buf_ptr, needle, start_ptr);
                if let Some(p) = r.0 {
                    buf_ptr = p;
                } else if let Some(v) = r.1 {
                    return Some(v);
    ...
    _memrnechr_tpl_remaining_3_bytes_impl(buf_ptr, cc.into(), start_ptr)
}

#[inline(always)]
pub(crate) fn _memrnechr_tpl_remaining_15_bytes_impl(
    buf_ptr: *const u8,
    cc: B8Tpl,
    start_ptr: *const u8,
) -> Option<usize> {
...
#[inline(always)]
pub(crate) fn _memrnechr_tpl_remaining_7_bytes_impl(
    buf_ptr: *const u8,
    cc: B4Tpl,
    start_ptr: *const u8,
) -> Option<usize> {
...
#[inline(always)]
fn _memrnechr_tpl_remaining_3_bytes_impl(
    buf_ptr: *const u8,
    cc: B2Tpl,
    start_ptr: *const u8,
) -> Option<usize> {
...
#[inline(always)]
fn _return_rnechr_tpl<T, PU>(base: T, bits_ab: PU) -> Option<usize>
where
...
#[inline(always)]
fn _rnechr_c16_uu_x1(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
    _rnechr_c16_aa_x1(buf_ptr, c16, st_ptr)
}

#[inline(always)]
fn _rnechr_c16_aa_x1(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
    ...
    //
    _return_rnechr_tpl(base, bits_0_abc)
}

#[inline(always)]
fn _rnechr_c16_aa_x2(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c16_aa_x4(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c16_aa_x8(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c8_uu_x1(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
    _rnechr_c8_aa_x1(buf_ptr, c8, st_ptr)
}

#[inline(always)]
fn _rnechr_c8_aa_x1(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c8_aa_x2(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c8_aa_x4(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c8_aa_x8(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c4_uu_x1(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
    _rnechr_c4_aa_x1(buf_ptr, c4, st_ptr)
}

#[inline(always)]
fn _rnechr_c4_aa_x1(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c4_aa_x2(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c4_aa_x4(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c4_aa_x8(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c2_aa_x1(buf_ptr: *const u8, c2: B2Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_c1_aa_x1(buf_ptr: *const u8, c1: B1Tpl, st_ptr: *const u8) -> Option<usize> {
    let aa_ptr = buf_ptr;
