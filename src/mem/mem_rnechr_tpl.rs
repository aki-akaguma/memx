...
#[cfg(any(target_pointer_width = "64", feature = "test_pointer_width_64"))]
#[inline(always)]
fn _start_rnechr_tpl_64(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    let buf_len = buf.len();
    ...
    if buf_len >= 8 {
        ...
        // the loop
        {
            let (r, p) = _unroll_loop_backward_with_prefetch::<4, 8, _>(buf_ptr, start_ptr, |p| {
                _rnechr_tpl_c8_aa_x1(p, cc, start_ptr)
            });
            if r.is_some() {
                return r;
            }
...
#[inline(always)]
fn _start_rnechr_tpl_32(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    let buf_len = buf.len();
    let start_ptr = buf.as_ptr();
    let mut buf_ptr = unsafe { start_ptr.add(buf_len) };
    ...
    if buf_len >= 4 {
        ...
        // the loop
        {
            let (r, p) = _unroll_loop_backward_with_prefetch::<4, 4, _>(buf_ptr, start_ptr, |p| {
                _rnechr_tpl_c4_aa_x1(p, cc, start_ptr)
            });
            if r.is_some() {
                return r;
            }
...
pub(crate) fn _memrnechr_tpl_remaining_15_bytes_impl(
    ...
    if buf_ptr.is_aligned_u64() {
        ...
        if buf_ptr.is_not_under(start_ptr, loop_size) {
            ...
            let r = _rnechr_tpl_c8_aa_x1(buf_ptr, cc, start_ptr);
            if r.is_some() {
                return r;
            }
        }
...
pub(crate) fn _memrnechr_tpl_remaining_7_bytes_impl(
    ...
    if buf_ptr.is_aligned_u32() {
        ...
        if buf_ptr.is_not_under(start_ptr, loop_size) {
            buf_ptr = unsafe { buf_ptr.sub(loop_size) };
            let r = _rnechr_tpl_c4_aa_x1(buf_ptr, cc, start_ptr);
            if r.is_some() {
                return r;
            }
        }
...
fn _memrnechr_tpl_remaining_3_bytes_impl(
    ...
    if buf_ptr.is_aligned_u16() {
        ...
        if buf_ptr.is_not_under(start_ptr, loop_size) {
            buf_ptr = unsafe { buf_ptr.sub(loop_size) };
            let r = _rnechr_tpl_c2_aa_x1(buf_ptr, cc, start_ptr);
            if r.is_some() {
                return r;
            }
        }
    }
    {
        ...
        while buf_ptr.is_not_under(start_ptr, loop_size) {
            buf_ptr = unsafe { buf_ptr.sub(loop_size) };
            let r = _rnechr_tpl_c1_aa_x1(buf_ptr, cc.into(), start_ptr);
            if r.is_some() {
                return r;
            }
        }
...
#[inline(always)]
fn _rnechr_tpl_c16_uu_x1(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
    _rnechr_tpl_c16_aa_x1(buf_ptr, c16, st_ptr)
}

#[inline(always)]
fn _rnechr_tpl_c16_aa_x1(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_tpl_c8_uu_x1(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
    _rnechr_tpl_c8_aa_x1(buf_ptr, c8, st_ptr)
}

#[inline(always)]
fn _rnechr_tpl_c8_aa_x1(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_tpl_c4_uu_x1(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
    _rnechr_tpl_c4_aa_x1(buf_ptr, c4, st_ptr)
}

#[inline(always)]
fn _rnechr_tpl_c4_aa_x1(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_tpl_c2_aa_x1(buf_ptr: *const u8, c2: B2Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rnechr_tpl_c1_aa_x1(buf_ptr: *const u8, c1: B1Tpl, st_ptr: *const u8) -> Option<usize> {
    let aa_ptr = buf_ptr;
...
fn _rnechr_tpl_to_aligned<const ALIGN: usize>(
    ...
    while cur_ptr > buf_ptr_min {
        ...
        if let Some(pos) = _rnechr_tpl_c1_aa_x1(cur_ptr, c, start_ptr) {
