...
macro_rules! _unroll_one_rchr_to_aligned_x1 {
    ($buf_ptr_2:expr, $buf_ptr_min:expr, $c:expr, $start_ptr:expr) => {{
        ...
        let r = _rchr_tpl_c1_aa_x1($buf_ptr_2, $c, $start_ptr);
        if r.is_some() {
            return (None, r);
        }
    }};
...
#[inline(always)]
pub(crate) fn _rchr_tpl_to_aligned_u256(
...
#[inline(always)]
pub(crate) fn _rchr_tpl_to_aligned_u128(
    buf_ptr_cur: *const u8,
    c: B1Tpl,
    st_ptr: *const u8,
) -> (Option<*const u8>, Option<usize>) {
...
fn _start_rchr_128(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    ...
    if buf_len >= 16 {
        ...
        /*
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                ...
                let r = _rchr_tpl_c16_aa_x8(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        */
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c16_aa_x4(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        /*
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c16_aa_x2(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        */
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c16_aa_x1(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
    ...
    _memrchr_tpl_remaining_15_bytes_impl(buf_ptr, cc.into(), start_ptr)
}
...
fn _start_rchr_64(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    ...
    if buf_len >= 8 {
        ...
        /*
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c8_aa_x8(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        */
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c8_aa_x4(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        /*
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c8_aa_x2(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        */
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c8_aa_x1(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
    ...
    _memrchr_tpl_remaining_7_bytes_impl(buf_ptr, cc.into(), start_ptr)
}
...
fn _start_rchr_32(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    ...
    if buf_len >= 4 {
        ...
        /*
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                ...
                let r = _rchr_tpl_c4_aa_x8(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        */
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c4_aa_x4(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        /*
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c4_aa_x2(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
        ...
        */
        {
            ...
            while buf_ptr.is_not_under(start_ptr, loop_size * unroll) {
                buf_ptr = unsafe { buf_ptr.sub(loop_size * unroll) };
                let r = _rchr_tpl_c4_aa_x1(buf_ptr, cc, start_ptr);
                if r.is_some() {
                    return r;
                }
            }
    ...
    _memrchr_tpl_remaining_3_bytes_impl(buf_ptr, cc.into(), start_ptr)
}

#[inline(always)]
pub(crate) fn _memrchr_tpl_remaining_15_bytes_impl(
    buf_ptr: *const u8,
    cc: B8Tpl,
    start_ptr: *const u8,
) -> Option<usize> {
...
#[inline(always)]
pub(crate) fn _memrchr_tpl_remaining_7_bytes_impl(
    buf_ptr: *const u8,
    cc: B4Tpl,
    start_ptr: *const u8,
) -> Option<usize> {
...
#[inline(always)]
fn _memrchr_tpl_remaining_3_bytes_impl(
    buf_ptr: *const u8,
    cc: B2Tpl,
    start_ptr: *const u8,
) -> Option<usize> {
    ...
    if buf_ptr.is_aligned_u16() {
        ...
        if buf_ptr.is_not_under(start_ptr, loop_size) {
            buf_ptr = unsafe { buf_ptr.sub(loop_size) };
            let r = _rchr_tpl_c2_aa_x1(buf_ptr, cc, start_ptr);
            if r.is_some() {
                return r;
            }
        }
    }
    {
        ...
        while buf_ptr.is_not_under(start_ptr, loop_size) {
            buf_ptr = unsafe { buf_ptr.sub(loop_size) };
            let r = _rchr_tpl_c1_aa_x1(buf_ptr, cc.into(), start_ptr);
            if r.is_some() {
                return r;
            }
        }
...
#[inline(always)]
fn _return_rchr_tpl<T, PU>(base: T, bits_a: PU, bits_b: PU, bits_c: PU) -> Option<usize>
where
...
#[inline(always)]
fn _rchr_tpl_c16_aa_x1(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rchr_tpl_c16_aa_x2(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c16_aa_x1(unsafe { buf_ptr.add(16) }, c16, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c16_aa_x1(buf_ptr, c16, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c16_aa_x4(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c16_aa_x2(unsafe { buf_ptr.add(16 * 2) }, c16, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c16_aa_x2(buf_ptr, c16, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c16_aa_x8(buf_ptr: *const u8, c16: B16Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c16_aa_x4(unsafe { buf_ptr.add(16 * 4) }, c16, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c16_aa_x4(buf_ptr, c16, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c8_uu_x1(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
    _rchr_tpl_c8_aa_x1(buf_ptr, c8, st_ptr)
}

#[inline(always)]
fn _rchr_tpl_c8_aa_x1(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rchr_tpl_c8_aa_x2(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c8_aa_x1(unsafe { buf_ptr.add(8) }, c8, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c8_aa_x1(buf_ptr, c8, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c8_aa_x4(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c8_aa_x2(unsafe { buf_ptr.add(8 * 2) }, c8, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c8_aa_x2(buf_ptr, c8, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c8_aa_x8(buf_ptr: *const u8, c8: B8Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c8_aa_x4(unsafe { buf_ptr.add(8 * 4) }, c8, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c8_aa_x4(buf_ptr, c8, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c4_uu_x1(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
    _rchr_tpl_c4_aa_x1(buf_ptr, c4, st_ptr)
}

#[inline(always)]
fn _rchr_tpl_c4_aa_x1(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
fn _rchr_tpl_c4_aa_x2(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c4_aa_x1(unsafe { buf_ptr.add(4) }, c4, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c4_aa_x1(buf_ptr, c4, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c4_aa_x4(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c4_aa_x2(unsafe { buf_ptr.add(4 * 2) }, c4, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c4_aa_x2(buf_ptr, c4, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c4_aa_x8(buf_ptr: *const u8, c4: B4Tpl, st_ptr: *const u8) -> Option<usize> {
    let r = _rchr_tpl_c4_aa_x4(unsafe { buf_ptr.add(4 * 4) }, c4, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_tpl_c4_aa_x4(buf_ptr, c4, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
#[inline(always)]
fn _rchr_tpl_c2_aa_x1(buf_ptr: *const u8, c2: B2Tpl, st_ptr: *const u8) -> Option<usize> {
...
#[inline(always)]
pub fn _memrchr_impl(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    for i in 0..buf.len() {
        let j = buf.len() - i - 1;
        if buf[j] == needle.v1 || buf[j] == needle.v2 || buf[j] == needle.v3 {
            return Some(j);
        }
    }
    None
