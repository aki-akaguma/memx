...
macro_rules! _unroll_one_rchr_to_align {
...
macro_rules! _unroll_one_rchr_to_align_x4 {
    ($buf_ptr_2:expr, $buf_ptr_min:expr, $c:expr, $start_ptr:expr) => {{
        _unroll_one_rchr_to_align!($buf_ptr_2, $buf_ptr_min, $c, $start_ptr);
        _unroll_one_rchr_to_align!($buf_ptr_2, $buf_ptr_min, $c, $start_ptr);
        _unroll_one_rchr_to_align!($buf_ptr_2, $buf_ptr_min, $c, $start_ptr);
        _unroll_one_rchr_to_align!($buf_ptr_2, $buf_ptr_min, $c, $start_ptr);
    }};
...
pub(crate) fn _rchr_to_aligned_u256(
    ...
    loop {
        _unroll_one_rchr_to_align_x4!(buf_ptr_2, buf_ptr_min, c, start_ptr);
        _unroll_one_rchr_to_align_x4!(buf_ptr_2, buf_ptr_min, c, start_ptr);
        _unroll_one_rchr_to_align_x4!(buf_ptr_2, buf_ptr_min, c, start_ptr);
        _unroll_one_rchr_to_align_x4!(buf_ptr_2, buf_ptr_min, c, start_ptr);
        //
...
pub(crate) fn _memrchr_remaining_3_bytes_impl(
    ...
    }
    {
        ...
        if unsafe { buf_ptr_cur.offset_from(start_ptr) } >= loop_size as isize {
            ...
            while unsafe { buf_ptr.offset_from(start_ptr) } >= loop_size as isize {
                buf_ptr = unsafe { buf_ptr.sub(loop_size) };
                _unroll_one_rchr_1!(buf_ptr, cc as u8, start_ptr, loop_size, 0);
            }
        }
    }
    //
...
#[inline(always)]
pub(crate) fn _rchr_c16(buf_ptr: *const u8, c16: u128, start_ptr: *const u8) -> Option<usize> {
