...
#[inline(always)]
fn _cpy_small(dst_ptr: *mut u8, src_ptr: *const u8, src_len: usize, end_ptr: *const u8) -> (*mut u8, *const u8) {
...
#[inline(always)]
fn _cpy_large(dst_ptr: *mut u8, src_ptr: *const u8, src_len: usize, end_ptr: *const u8) -> (*mut u8, *const u8) {
    let mut a_ptr = dst_ptr;
    let mut b_ptr = src_ptr;
    let remaining_len = {
        let remaining_align = 0x10_usize - ((a_ptr as usize) & 0x0F_usize);
