...
unsafe fn _chr_qpl_c16_aa_x2(
    ...
    let r = unsafe { _chr_qpl_c16_aa_x1(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_qpl_c16_aa_x1(buf_ptr.add(16), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_qpl_c16_aa_x4(
    ...
    let r = unsafe { _chr_qpl_c16_aa_x2(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_qpl_c16_aa_x2(buf_ptr.add(16 * 2), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_qpl_c16_aa_x8(
    ...
    let r = unsafe { _chr_qpl_c16_aa_x4(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_qpl_c16_aa_x4(buf_ptr.add(16 * 4), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_qpl_c32_aa_x2(
    ...
    let r = unsafe { _chr_qpl_c32_aa_x1(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_qpl_c32_aa_x1(buf_ptr.add(32), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_qpl_c32_aa_x4(
    ...
    let r = unsafe { _chr_qpl_c32_aa_x2(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_qpl_c32_aa_x2(buf_ptr.add(32 * 2), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_qpl_c32_aa_x8(
    ...
    let r = unsafe { _chr_qpl_c32_aa_x4(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_qpl_c32_aa_x4(buf_ptr.add(32 * 4), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
