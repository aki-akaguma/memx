...
#[inline(always)]
pub(crate) fn _memrnechr_qpl_impl(buf: &[u8], needle: B1Qpl) -> Option<usize> {
...
unsafe fn _memrnechr_qpl_basic(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    basic::_memrnechr_qpl_impl(buf, needle)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[target_feature(enable = "sse2")]
#[allow(clippy::missing_safety_doc)]
pub unsafe fn _memrnechr_qpl_sse2(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    _memrnechr_qpl_sse2_impl(buf, needle)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[target_feature(enable = "avx2")]
#[allow(clippy::missing_safety_doc)]
pub unsafe fn _memrnechr_qpl_avx2(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    _memrnechr_qpl_avx2_impl(buf, needle)
}

#[inline(always)]
fn _memrnechr_qpl_sse2_impl(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    let buf_len = buf.len();
    ...
    if buf_len >= 16 {
        ...
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u128() {
                ...
                {
                    let r = basic::_rnechr_qpl_to_aligned_u128(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
    ...
    basic::_memrnechr_qpl_remaining_15_bytes_impl(buf_ptr, cc, start_ptr)
}

#[inline(always)]
fn _memrnechr_qpl_avx2_impl(buf: &[u8], needle: B1Qpl) -> Option<usize> {
    let buf_len = buf.len();
    let start_ptr = buf.as_ptr();
    let mut buf_ptr = unsafe { start_ptr.add(buf_len) };
    //
    if buf_len >= 32 {
        ...
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u256() {
                ...
                #[cfg(feature = "test_alignment_check")]
                {
                    let r = basic::_rnechr_qpl_to_aligned_u256(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
                    } else if let Some(v) = r.1 {
                        return Some(v);
...
#[inline(always)]
fn _return_rnechr_qpl<T, PU>(base: T, mask_a: PU) -> Option<usize>
where
...
unsafe fn _rnechr_c16_uu_x1(
    ...
    let mask_0_abcd = unsafe {
        ...
        _mm_movemask_epi8(mm_0_eq_abcd) as u16
    };
...
unsafe fn _rnechr_c16_aa_x2(
    ...
    let r = unsafe { _rnechr_c16_aa_x1(buf_ptr.add(16), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _rnechr_c16_aa_x1(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rnechr_c16_aa_x4(
    ...
    let r = unsafe { _rnechr_c16_aa_x2(buf_ptr.add(16 * 2), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _rnechr_c16_aa_x2(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rnechr_c16_aa_x8(
    ...
    let r = unsafe { _rnechr_c16_aa_x4(buf_ptr.add(16 * 4), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _rnechr_c16_aa_x4(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rnechr_c32_uu_x1(
    ...
    let mask_0_abcd = unsafe {
        ...
        _mm256_movemask_epi8(mm_0_eq_abcd) as u32
    };
...
unsafe fn _rnechr_c32_aa_x2(
    ...
    let r = unsafe { _rnechr_c32_aa_x1(buf_ptr.add(32), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _rnechr_c32_aa_x1(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rnechr_c32_aa_x4(
    ...
    let r = unsafe { _rnechr_c32_aa_x2(buf_ptr.add(32 * 2), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _rnechr_c32_aa_x2(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rnechr_c32_aa_x8(
    ...
    let r = unsafe { _rnechr_c32_aa_x4(buf_ptr.add(32 * 4), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _rnechr_c32_aa_x4(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
