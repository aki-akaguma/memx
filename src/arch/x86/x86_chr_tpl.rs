...
#[inline(always)]
pub(crate) fn _memchr_tpl_impl(buf: &[u8], needle: B1Tpl) -> Option<usize> {
...
unsafe fn _memchr_tpl_basic(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    basic::_memchr_tpl_impl(buf, needle)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[target_feature(enable = "sse2")]
#[allow(clippy::missing_safety_doc)]
pub unsafe fn _memchr_tpl_sse2(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    _memchr_tpl_sse2_impl(buf, needle)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[target_feature(enable = "avx2")]
#[allow(clippy::missing_safety_doc)]
pub unsafe fn _memchr_tpl_avx2(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    _memchr_tpl_avx2_impl(buf, needle)
}

#[inline(always)]
fn _memchr_tpl_sse2_impl(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    let buf_len = buf.len();
    ...
    if buf_len >= 16 {
        ...
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u128() {
                ...
                {
                    let r = basic::_chr_tpl_to_aligned_u128(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
...
#[inline(always)]
fn _memchr_tpl_avx2_impl(buf: &[u8], needle: B1Tpl) -> Option<usize> {
    let buf_len = buf.len();
    let mut buf_ptr = buf.as_ptr();
    let start_ptr = buf_ptr;
    let end_ptr = unsafe { buf_ptr.add(buf_len) };
    ...
    if buf_len >= 32 {
        ...
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u256() {
                ...
                #[cfg(feature = "test_alignment_check")]
                {
                    let r = basic::_chr_tpl_to_aligned_u256(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
                    } else if let Some(v) = r.1 {
                        return Some(v);
...
#[inline(always)]
fn _return_chr_tpl<T, PU>(base: T, mask_a: PU, mask_b: PU, mask_c: PU) -> Option<usize>
where
...
unsafe fn _chr_tpl_c16_uu_x1(
    ...
    unsafe {
        ...
        //
        _return_chr_tpl(base, mask_0_a, mask_0_b, mask_0_c)
    }
}
...
unsafe fn _chr_tpl_c16_aa_x2(
    ...
    let r = unsafe { _chr_tpl_c16_aa_x1(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_tpl_c16_aa_x1(buf_ptr.add(16), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_tpl_c16_aa_x4(
    ...
    let r = unsafe { _chr_tpl_c16_aa_x2(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_tpl_c16_aa_x2(buf_ptr.add(16 * 2), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_tpl_c16_aa_x8(
    ...
    let r = unsafe { _chr_tpl_c16_aa_x4(buf_ptr, mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_tpl_c16_aa_x4(buf_ptr.add(16 * 4), mm_c16, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_tpl_c32_aa_x2(
    ...
    let r = unsafe { _chr_tpl_c32_aa_x1(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_tpl_c32_aa_x1(buf_ptr.add(32), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_tpl_c32_aa_x4(
    ...
    let r = unsafe { _chr_tpl_c32_aa_x2(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_tpl_c32_aa_x2(buf_ptr.add(32 * 2), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _chr_tpl_c32_aa_x8(
    ...
    let r = unsafe { _chr_tpl_c32_aa_x4(buf_ptr, mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    let r = unsafe { _chr_tpl_c32_aa_x4(buf_ptr.add(32 * 4), mm_c32, st_ptr) };
    if r.is_some() {
        return r;
    }
    None
