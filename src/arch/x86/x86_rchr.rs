...
#[inline(always)]
pub(crate) fn _memrchr_sgl_impl(buf: &[u8], needle: B1Sgl) -> Option<usize> {
...
unsafe fn _memrchr_sgl_basic(buf: &[u8], needle: B1Sgl) -> Option<usize> {
    basic::_memrchr_sgl_impl(buf, needle)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[target_feature(enable = "sse2")]
#[allow(clippy::missing_safety_doc)]
pub unsafe fn _memrchr_sgl_sse2(buf: &[u8], needle: B1Sgl) -> Option<usize> {
    _memrchr_sgl_sse2_impl(buf, needle)
}

#[cfg(any(target_arch = "x86_64", target_arch = "x86"))]
#[target_feature(enable = "avx2")]
#[allow(clippy::missing_safety_doc)]
pub unsafe fn _memrchr_sgl_avx2(buf: &[u8], needle: B1Sgl) -> Option<usize> {
    _memrchr_sgl_avx2_impl(buf, needle)
}

#[inline(always)]
fn _memrchr_sgl_sse2_impl(buf: &[u8], needle: B1Sgl) -> Option<usize> {
    let buf_len = buf.len();
        ...
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u128() {
                #[cfg(not(feature = "test_alignment_check"))]
                {
                    ...
                    let r = unsafe { _rchr_sgl_c16_uu_x1(buf_ptr_pre, cc, start_ptr) };
                    if r.is_some() {
                        return r;
                    }
...
#[allow(clippy::missing_safety_doc)]
#[inline(always)]
fn _memrchr_sgl_avx2_impl(buf: &[u8], needle: B1Sgl) -> Option<usize> {
    let buf_len = buf.len();
    let start_ptr = buf.as_ptr();
    let mut buf_ptr = unsafe { start_ptr.add(buf_len) };
    //
        ...
        // to a aligned pointer
        {
            if !buf_ptr.is_aligned_u256() {
                #[cfg(not(feature = "test_alignment_check"))]
                {
                    let loop_size = 32;
                    let buf_ptr_pre = unsafe { buf_ptr.sub(loop_size) };
                    let r = unsafe { _rchr_sgl_c32_uu_x1(buf_ptr_pre, cc, start_ptr) };
                    if r.is_some() {
                        return r;
                    }
                ...
                #[cfg(feature = "test_alignment_check")]
                {
                    let r = basic::_rchr_sgl_to_aligned_u256(buf_ptr, needle, start_ptr);
                    if let Some(p) = r.0 {
                        buf_ptr = p;
                    } else if let Some(v) = r.1 {
                        return Some(v);
...
#[inline(always)]
fn _return_rchr_sgl<T, PU>(base: T, mask_a: PU) -> Option<usize>
where
...
unsafe fn _rchr_sgl_c16_uu_x1(
    ...
    //
    _return_rchr_sgl(base, mask_0_a)
}

#[inline(always)]
unsafe fn _rchr_sgl_c16_aa_x1(
    buf_ptr: *const u8,
    mm_c16: MMB16Sgl,
    st_ptr: *const u8,
) -> Option<usize> {
...
unsafe fn _rchr_sgl_c16_aa_x2(
    ...
    let r = _rchr_sgl_c16_aa_x1(buf_ptr.add(16), mm_c16, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_sgl_c16_aa_x1(buf_ptr, mm_c16, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rchr_sgl_c16_aa_x4(
    ...
    let r = _rchr_sgl_c16_aa_x2(buf_ptr.add(16 * 2), mm_c16, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_sgl_c16_aa_x2(buf_ptr, mm_c16, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rchr_sgl_c16_aa_x8(
    ...
    let r = _rchr_sgl_c16_aa_x4(buf_ptr.add(16 * 4), mm_c16, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_sgl_c16_aa_x4(buf_ptr, mm_c16, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rchr_sgl_c32_aa_x2(
    ...
    let r = _rchr_sgl_c32_aa_x1(buf_ptr.add(32), mm_c32, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_sgl_c32_aa_x1(buf_ptr, mm_c32, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rchr_sgl_c32_aa_x4(
    ...
    let r = _rchr_sgl_c32_aa_x2(buf_ptr.add(32 * 2), mm_c32, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_sgl_c32_aa_x2(buf_ptr, mm_c32, st_ptr);
    if r.is_some() {
        return r;
    }
    None
...
unsafe fn _rchr_sgl_c32_aa_x8(
    ...
    let r = _rchr_sgl_c32_aa_x4(buf_ptr.add(32 * 4), mm_c32, st_ptr);
    if r.is_some() {
        return r;
    }
    let r = _rchr_sgl_c32_aa_x4(buf_ptr, mm_c32, st_ptr);
    if r.is_some() {
        return r;
    }
    None
